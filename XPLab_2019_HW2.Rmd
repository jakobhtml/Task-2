...
tooth_growth_tibble = group_by(iris_tibble, supp)
summarise(tooth_growth_tibble, length = mean(len))
...
in lower doses supplementation of OJ shows longer teeth than supplementation with VC. at dose of 2.0 the mean length could be roughly equal for both supps. 
